...
export default function AboutLanding() {
  return (
    <>
      <SEO
        title="About Geepay | Empowering Kenya Diaspora with Fast Money Transfers"
        description="Learn about Geepay's mission to make international money transfers to Kenya simple and affordable. Join thousands sending money home with transparency and speed."
        keywords="about Geepay, Kenya diaspora, international remittance company, money transfer service, about us"
        canonical="https://geepay.us/about"
      />
      <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <header className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">About Geepay</h1>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p className="text-gray-700">
              Geepay was founded to make international money transfers to Kenya simple, affordable, and instant.
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardTitle>Why Geepay?</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-700 mb-4">
              Geepay is trusted by thousands of people in the Kenyan diaspora who send money home regularly.
              Whether it's supporting family, investing in property, or managing business operations, Geepay
