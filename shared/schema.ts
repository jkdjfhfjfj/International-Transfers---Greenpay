...
// Multi-currency wallets (for currencies beyond the built-in USD/KES)
...
// Admin-configurable exchange rates (override live rates)
...
export const insertCurrencyRateSchema = createInsertSchema(currencyRates).omit({ id: true, updatedAt: true });
export type CurrencyRate = typeof currencyRates.$inferSelect;
export type InsertCurrencyRate = z.infer<typeof insertCurrencyRateSchema>;

// NexusPay deposit transactions
...
export const insertNexuspayTransactionSchema = createInsertSchema(nexuspayTransactions).omit({ id: true, createdAt: true, updatedAt: true });
export type NexuspayTransaction = typeof nexuspayTransactions.$inferSelect;
export type InsertNexuspayTransaction = z.infer<typeof insertNexuspayTransactionSchema>;
